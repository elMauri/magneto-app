...
* Si se ejecuta dos veces una cadena **valida** de ADN la aplicación retornará <code>**HTTP 200-OK**</code> sin embargo la misma no será tenida en cuenta para las estadísticas.
